...
require_once($_SERVER['DOCUMENT_ROOT']."/GUIService/ProducerChangePasswordService.php");
...
require_once($_SERVER['DOCUMENT_ROOT']."/Utilities/utility.php");
	...
	$objReg = new ProducerChangePasswordService();
	NAJAX_Server::allowClasses("ProducerChangePasswordService");
...
<script type="text/javascript" src="/IncludeFiles/Javascript/ProducerChangePassword.js"></script>
<script type="text/javascript" src="/IncludeFiles/Javascript/Messages.js"></script>

<script language="javascript">
var obj = <?= NAJAX_Client::register(new ProducerChangePasswordService()) ?>;
function createXml()
{
	...
	if(ValidateForm())
	{
		...
		var strResonse=obj.ProducerChangePassword('<?php echo $_SESSION[sessionKeys::USER_EMAIL]?>',document.getElementById("txtOldPassword").value,document.getElementById("txtNewPassword").value,function(result){parseXMLResponse(result);});
	}
}
