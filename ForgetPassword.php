<?php 
require_once($_SERVER['DOCUMENT_ROOT']."/GUIService/ForgetPasswordService.php");
...
<script type="text/javascript" src="/IncludeFiles/Javascript/ForgetPassword.js"></script>
...
function createXml()
{
	...
	if(ValidateForm())
	{
		...
		if(document.getElementById("cmbCustomerType").value==1) // for consumer
			var strResonse=obj.ConsumerForgetPassword(document.getElementById("txtEmail").value, document.getElementById("cmbSecretQuestion").value, document.getElementById("txtAnswer").value,function(result){parseXMLResponse(result);});		
		else if(document.getElementById("cmbCustomerType").value==2) // for producer
			var strResonse=obj.ProducerForgetPassword(document.getElementById("txtEmail").value, document.getElementById("cmbSecretQuestion").value, document.getElementById("txtAnswer").value,function(result){parseXMLResponse(result);});		
	}
		...
		if (window.ActiveXObject)
		{
			if(XMLDoc.loadXML(strResonse)==true)
			{
				...
				if(strStatus=="ok")
				{
					...
					document.getElementById("divError").innerHTML=FORGET_PASSWORD_SUCCESSFUL;
					document.getElementById("tr_id").style.display = 'inline';			
					document.getElementById("error").focus();			
				}
				else if(strStatus=="SecretAnswerNotCorrect")
				{
					document.getElementById("strip_image").src="/ImageFiles/common/error.gif";
					document.getElementById("divError").innerHTML=SECRET_ANSWER_NOT_CORRECT;
					document.getElementById("tr_id").style.display = 'inline';			
					document.getElementById("error").focus();			
        ...
        <td colspan="2"><table width="638" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td colspan="2" align="left" valign="middle"><input name="txtEmail" type="text" id="txtEmail" size="30">
                  <img src="/ImageFiles/common/questionIcon.jpg" width="20" height="20" align="absmiddle" onMouseover="ddrivetip(FORGET_PASSWORD_EMAIL_TOOLTIP,325)" onMouseout='hideddrivetip()'> </td>
            ...
            <tr>
              <td height="29" colspan="2" align="left" valign="top" class="RegistrationBodyText"><strong><strong><font color="red" size="3">*</font></strong>Secret Question: </strong></td>
              <td align="left">&nbsp;</td>
            </tr>
            <tr>
              <td height="22" colspan="2" align="left" valign="top" class="RegistrationBodyText"><select name="cmbSecretQuestion" id="cmbSecretQuestion" style="width:225px">
                  <?php $objReg->FillCmbSecretQuestion(1);?>
                </select>              </td>
              <td align="left">&nbsp;</td>
            </tr>
            <tr>
              <td height="19" colspan="2" align="left" valign="top" class="RegistrationBodyText">&nbsp;</td>
              <td align="left">&nbsp;</td>
            </tr>
            <tr>
              <td height="29" colspan="2" align="left" valign="top" class="RegistrationBodyText"><strong><strong><font color="red" size="3">*</font></strong>Answer: </strong></td>
              <td align="left">&nbsp;</td>
            </tr>
            <tr valign="middle">
              <td colspan="2" align="left"><input name="txtAnswer" type="text" id="txtAnswer" size="30">
                  <img src="/ImageFiles/common/questionIcon.jpg" width="20" height="20" align="absmiddle" onMouseover="ddrivetip(FORGET_PASSWORD_ANSWER_TOOLTIP,300)" onMouseout='hideddrivetip()'></td>
              <td align="left">&nbsp;</td>
            </tr>
            <tr>
              <td colspan="2" align="left">&nbsp;</td>
            ...
            <tr>
              <td colspan="2" align="left"><span class="RegistrationBodyText"><strong>as:
                    <label> </label>
              </strong>
                  <label>
