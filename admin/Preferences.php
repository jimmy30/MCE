...
function showSkin(skin)
{
	...
	strHtml+='<input name="Submit" type="button" class="RegistrationButton" value="Apply" onClick="location.href=\'<?php echo $_SERVER['PHP_SELF'];?>?skin='+skin+'\'">';
	strHtml+='</td>';
	strHtml+='</tr></table>';
...
<tr>
        ...
        <tr>
          <td height="19" align="center"><input name="Submit" type="button" class="RegistrationButton" value="Apply" onClick="location.href='<?php echo $_SERVER['PHP_SELF'];?>?skin=<?php echo $strSkin?>'"></td>
          </tr>            </table>
