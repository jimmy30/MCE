...
<table width="711" border="0" align="center" cellpadding="0" cellspacing="0" class="RegistrationTabBorder" height="90%">
  <form name="frmReport" action="" method="post" onSubmit="">
    ...
    <tr class="RegistrationCellBg">
      <td height="27" colspan="3"><p class="RegistrationTitleText"> &nbsp;&nbsp;Users Report </p></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="54" colspan="3"  class="RegistrationBodyText">
		...
		<?php
		if($_POST["hiddenFromDate"]!="" && $_POST["hiddenToDate"]!="")
		{
		?>Date
          <br>
    ...
    <tr valign="top">
      <td colspan="3"><div align="center"><?php echo $_POST["strHrmlProducer"]?>        </div>
      <div id="cContainer"></div></td>
    </tr>
    <tr valign="top">
      <td colspan="3"><div align="center"><?php echo $_POST["strHrmlConsumer"]?></div></td>
    </tr>
    <tr valign="top">
