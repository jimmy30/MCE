...
require_once($_SERVER['DOCUMENT_ROOT']."/GUIService/admin/Placecast/PlaceCastDetailService.php");
...
<table width="845" border="0" align="center" cellpadding="0" cellspacing="0" class="RegistrationTabBorder" height="100%">
  <form name="frmPlaceCast" action="" method="post" onSubmit="">
    ...
    <tr>
      <td height="18" colspan="2"><?php $objReg->GetPlaceCastById($_REQUEST["id"],3)?></td>
    </tr>
    <tr>
      <td colspan="2">       
      ...
      <td height="44" colspan="2"><table width="800" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td height="24" colspan="3" align="left" valign="top"><div align="center"><a href="ViewPlaceCast.php" class="LinkSmall">
              <input name="button" type="button" class="RegistrationButton" onClick="location.href='/admin/Placecast/ViewPlaceCast.php'" value="Back to PlaceCast">
            </a></div></td>
          </tr>
          <tr>
