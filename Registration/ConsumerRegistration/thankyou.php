...
<table width="670" border="0" align="center" cellpadding="0" cellspacing="0" class="RegistrationTabBorder" height="100%">
  <form name="frmRegistration" action="" method="post" onSubmit="return formvalidate()">
    <tr  class="RegistrationCellBg">
      ...
      <td width="677" align="left" valign="middle"><p class="RegistrationTitleText">Thank You!</p></td>
    </tr>
    <tr>
      <td height="5" colspan="2"></td>
    </tr>
    <tr align="left" valign="top">
      <td colspan="2"><table width="643" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td width="456">&nbsp;</td>
          </tr>
          <tr valign="top">
            <td align="left" class="RegistrationBodyText"><p><strong>Thank you for registering with www.mce.com</strong><br>
                    <br>
                As part of our final registration process, you must activate your account.<br>
                This is a one-time procedure and is only used for verifying your email address.<br>
                <br>
                To Activate your account please check your email account. <br>
                <br>
                Best Regards,<br>
                www.mce.com team<br>
            </p></td>
