...
require_once($_SERVER['DOCUMENT_ROOT']."/GUIService/Registration/ConsumerRegistration/RegistrationService.php");
...
<script type="text/javascript" src="/IncludeFiles/Javascript/Registration/ConsumerRegistration/registration.js"></script>
      ...
      <td colspan="2"><table width="638" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td colspan="2" align="left">&nbsp;</td>
				 ...
				 <tr>
                  <td width="173" height="29" align="left" valign="top" class="RegistrationBodyText"><strong><strong><font color="red" size="3">*</font></strong>Mobile Number: </strong></td>
                  <td colspan="2" width="173" height="29" align="left" valign="top" class="RegistrationBodyText"><strong>Cellular Provider : </strong></td>
                </tr>
                <tr>
      ...
      <td colspan="2"><table width="638" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td width="325" align="left" valign="middle"><input name="txtEmail" type="text" id="txtEmail" size="30">
                <img src="../../ImageFiles/common/questionIcon.jpg" width="20" height="20" align="absmiddle" onMouseover="ddrivetip(CONSUMER_REGISTRATION_EMAIL_TOOLTIP,325)" onMouseout='hideddrivetip()'></td>
          ...
          <tr>
            <td colspan="2" align="left" valign="middle"><input name="txtRePassword" type="password" id="txtRePassword" size="30">
    ...
    <tr align="center">
      <td colspan="2"><table width="638" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td width="132" align="left" valign="top"><input name="Submit" type="Button" class="RegistrationButton" id="Submit" value="Continue" onClick="createXml()"></td>
