...
require_once($_SERVER['DOCUMENT_ROOT']."/GUIService/Registration/ProducerRegistration/ProducerActivationService.php");
...
require_once($_SERVER['DOCUMENT_ROOT']."/Utilities/utility.php");
	...
	$objReg = new ProducerActivationService();
	NAJAX_Server::allowClasses("ProducerActivationService");
...
<script type="text/javascript" src="/IncludeFiles/Javascript/Registration/ProducerRegistration/ProducerActivation.js"></script>
<script type="text/javascript" src="/IncludeFiles/Javascript/Messages.js"></script>

<script language="javascript">
var obj = <?= NAJAX_Client::register(new ProducerActivationService()) ?>;
...
function createXml()
{
	...
	if(ValidateForm())
	{
		...
		var strResonse=obj.ProducerActivation(document.getElementById("txtEmail").value,document.getElementById("txtCode").value,function(result){parseXMLResponse(result);});
	}
}
        ...
        <table width="638" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td colspan="2" align="left" valign="middle"><input name="txtEmail" type="text" id="txtEmail" size="30" value="<?php if(isset($_REQUEST["EMAIL"])) echo $_REQUEST["EMAIL"];?>">
                <img src="/ImageFiles/common/questionIcon.jpg" width="20" height="20" align="absmiddle" onMouseover="ddrivetip(PRODUCER_ACTIVATION_EMAIL_TOOLTIP,325)" onMouseout='hideddrivetip()'> </td>
          ...
          <tr valign="middle">
            <td colspan="4" align="left"><input name="txtCode" type="text" id="txtCode" size="30" value="<?php if(isset($_REQUEST["id"])) echo $_REQUEST["id"]; ?>">
                <img src="/ImageFiles/common/questionIcon.jpg" width="20" height="20" align="absmiddle" onMouseover="ddrivetip(PRODUCER_ACTIVATION_CODE_TOOLTIP,325)" onMouseout='hideddrivetip()'></td>
          </tr>
          <tr>
