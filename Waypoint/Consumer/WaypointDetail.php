...
require_once($_SERVER['DOCUMENT_ROOT']."/GUIService/Waypoint/Consumer/WaypointDetailService.php");
    ...
    <tr>
      <td height="18" colspan="2">
        <table border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td width="380" rowspan="2" valign="top"><?php $objReg->GetWaypointById($_REQUEST["id"],1)?></td>
