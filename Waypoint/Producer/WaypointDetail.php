...
require_once($_SERVER['DOCUMENT_ROOT']."/GUIService/Waypoint/Producer/WaypointDetailService.php");
...
<script language="javascript" src="../../IncludeFiles/JavaScript/YahooWaypointDetail.js"></script>
  ...
  <form name="frmWaypoint" action="" method="post" onSubmit="">
    ...
    <tr>
      <td height="18" colspan="2"><table border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td width="380" rowspan="2" valign="top"><?php $objReg->GetWaypointById($_REQUEST["id"],3)?></td>
    ...
    <tr align="left">
      <td height="44" colspan="2"><table width="660" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="24" colspan="3" align="left" valign="top"><div align="center"><input name="button" type="button" class="RegistrationButton" onClick="location.href='ViewWaypoint.php?id=<?php echo $_REQUEST['pid']?>'" value="Back to Waypoint">
            </div></td>
          </tr>
          <tr>
...
<script language="javascript">
	...
	loadmap('<?php echo $_REQUEST["long1"]?>','<?php echo $_REQUEST["lat1"]?>','<?php echo $_REQUEST["long2"]?>','<?php echo $_REQUEST["lat2"]?>','<?php echo $_REQUEST["long3"]?>','<?php echo $_REQUEST["lat3"]?>','<?php echo $_REQUEST["long4"]?>','<?php echo $_REQUEST["lat4"]?>',document.getElementById("hiddenLat").value,document.getElementById("hiddenLong").value,document.getElementById("hiddenRadius").value,intCounter);
</script>