...
//////////////////////////////////////////////////////////////////////////////////////
/// This is a service classs and Used for Consumer Registration.
//////////////////////////////////////////////////////////////////////////////////////
...
//			fclose($handle);
	...
	/// INSERT CONSUMER
	function InsertConsumer($pIntCountryId, $pIntStateId, $pIntAccountType, $pChrEmail, $pChrPassword, $pChrFirstName, $pChrLastName, $pChrAddress, $pChrCity, $pChrZipCode, $pChrTelephone1, $pDteDateOfBirth, $pIntSecretQuestion, $pChrAnswer, $pStrActivationCode, $pIntIsVerified, $pDteCreateDate, $pIntIsActive,$strMobileNumber,$intCellularId)
	{
		...
		try
		{
			...
			$array=$objConsumerDAO->insert($objConsumerBO,0);
	...
	{
		NAJAX_Client::mapMethods($this, array('FillCmbStateByCountryId','InsertConsumer','FillCmbCellularByCountryId'));

		NAJAX_Client::publicMethods($this, array('FillCmbStateByCountryId','InsertConsumer','FillCmbCellularByCountryId'));
	}
}
