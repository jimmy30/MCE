...
class ViewPlaceCastService
{
	...
	function GetListActive($start,$limit,$pIntIsActive,$pIntSortListBy)
	{
		...
		$objPlaceCastBOAarray=$objPlaceCastDAO->GetListActive($start,$limit,$pIntIsActive,$pIntSortListBy);
		...
		if ($objPlaceCastBOAarray[0][0]!=null)
		{
			...
			for($i=0; $i<$intCount; $i++)
			{
				...
				$strXML.='<PlaceCastIsActive>'.$objPlaceCastBO->getPlaceCastIsActive().'</PlaceCastIsActive>';
				$strXML.='</PlaceCast>';
...
=================================================================================*/
	...
	function PlaceCastRecordCount($pIntIsActive)
	{
		/// Call procedure
		$objPlaceCastDAO = new PlaceCastDAO();
		$numRows=$objPlaceCastDAO->PlaceCastRecordCount($pIntIsActive);
		return $numRows;
	}	 
...
=================================================================================*/
	...
	function ToggleIsActive($pIntPlaceCastId,$pIntIsActive)
	{
		...
		$objPlaceCastDAO = new PlaceCastDAO();
		$intStatus = $objPlaceCastDAO->ToggleIsActive($pIntPlaceCastId,$pIntIsActive);
		return $intStatus;
	}
	...
	function downloadPlaceCast($pIntPlaceCastId)
	{
	...
	{
		NAJAX_Client::mapMethods($this, array('GetListActive','PlaceCastDeleteById','PlaceCastRecordCount','getPagingLimit','paging','ToggleIsActive','getListPlaceCastFolder','downloadPlaceCast'));

		NAJAX_Client::publicMethods($this, array('GetListActive','PlaceCastDeleteById','PlaceCastRecordCount','getPagingLimit','paging','ToggleIsActive','getListPlaceCastFolder','downloadPlaceCast'));
	}
