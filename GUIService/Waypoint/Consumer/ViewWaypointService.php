...
//// Include DO BO class for WaypointDownload Table
require_once($_SERVER['DOCUMENT_ROOT']."/Database/DAO/WaypointDownloadDAO.php");
require_once($_SERVER['DOCUMENT_ROOT']."/Database/BO/WaypointDownloadBO.php");
...
class ViewWaypointService
{
	...
	function GetPlaceCastById($pPlaceCastId,$pIsActive)	 
	{
		...
		if ($objPlaceCastBO!=null)
		{
			...
			$strXML.='<PlaceCastLat1>'.$objPlaceCastBO->getPlaceCastLat1().'</PlaceCastLat1>';	
			$strXML.='<PlaceCastLong1>'.$objPlaceCastBO->getPlaceCastLong1().'</PlaceCastLong1>';	
			$strXML.='<PlaceCastLat2>'.$objPlaceCastBO->getPlaceCastLat2().'</PlaceCastLat2>';	
			$strXML.='<PlaceCastLong2>'.$objPlaceCastBO->getPlaceCastLong2().'</PlaceCastLong2>';	
			$strXML.='<PlaceCastLat3>'.$objPlaceCastBO->getPlaceCastLat3().'</PlaceCastLat3>';	
			$strXML.='<PlaceCastLong3>'.$objPlaceCastBO->getPlaceCastLong3().'</PlaceCastLong3>';	
			$strXML.='<PlaceCastLat4>'.$objPlaceCastBO->getPlaceCastLat4().'</PlaceCastLat4>';	
			$strXML.='<PlaceCastLong4>'.$objPlaceCastBO->getPlaceCastLong4().'</PlaceCastLong4>';	
...
=================================================================================*/
	...
	function downloadWayPoint($pIntWaypointId,$pIntPlaceCastId,$pConsumerId,$pWaypointDownloadCreateDate,$pWaypointDownloadIsActive)
	{
		// To Do.......
...
//		return $strFilePath;
		...
		if ($v_list == 0) 
		{
			...
			try
			{
				$objWaypointDownloadBO = new WaypointDownloadBO();
				$objWaypointDownloadBO->setConsumerId($pConsumerId);
				$objWaypointDownloadBO->setWaypointId($pIntWaypointId);
				$objWaypointDownloadBO->setWaypointDownloadCreateDate($pWaypointDownloadCreateDate);
				$objWaypointDownloadBO->setWaypointDownloadIsActive($pWaypointDownloadIsActive);
				
				$objWaypointDownloadDAO = new WaypointDownloadDAO();
				$objWaypointDownloadDAO->insert($objWaypointDownloadBO);
			}
			catch(Exception $e)
				{
					return "exception";				
	...
	{
		NAJAX_Client::mapMethods($this, array('GetListByPlaceCastId','GetListActive','WaypointDeleteById','WaypointRecordCount','WaypointRecordCountByPlaceCast','getPagingLimit','paging','getListWaypointFolder','downloadWayPoint','GetPlaceCastById'));

		NAJAX_Client::publicMethods($this, array('GetListByPlaceCastId','GetListActive','WaypointDeleteById','WaypointRecordCount','WaypointRecordCountByPlaceCast','getPagingLimit','paging','getListWaypointFolder','downloadWayPoint','GetPlaceCastById'));
	}
