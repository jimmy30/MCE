...
class WaypointDetailService
{
	...
	try
	{
        ...
        <tr>
          ...
          <td bgcolor="#EEEEEE" colspan="2" width="220" class="RegistrationBodyText">'.$objWaypointBO->getWaypointName().'</td>
        </tr>
        <tr>
	  ...
	  <br>
		  ...
		  <td class="TabTopTextHightLight" width="100"><div align="left"><strong>Radius</strong></div></td>
        </tr>
...
<input type="hidden" name="hiddenLat" id="hiddenLat" value="'.$objWaypointBO->getWaypointLat1().'">
<input type="hidden" name="hiddenLong" id="hiddenLong" value="'.$objWaypointBO->getWaypointLong1().'">
<input type="hidden" name="hiddenRadius" id="hiddenRadius" value="'.$objWaypointBO->getWaypointRadius().'">
';		
		}
		else
		{
