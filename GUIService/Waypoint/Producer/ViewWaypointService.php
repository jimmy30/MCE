...
=================================================================================*/
	...
	function GetPlaceCastInactive($pPlaceCastId, $IsActive)
	{
		$objPlaceCast = new PlaceCastDAO();
		$objPlaceCast->ToggleIsActive($pPlaceCastId, $IsActive);
	}
	/// Mapping functions for najax use
	function najaxGetMeta()
	{
		NAJAX_Client::mapMethods($this, array('GetListByPlaceCastId','GetListActive','WaypointDeleteById','WaypointRecordCount','WaypointRecordCountByPlaceCast','getPagingLimit','paging','getListWaypointFolder','GetPlaceCastById','GetPlaceCastInactive'));

		NAJAX_Client::publicMethods($this, array('GetListByPlaceCastId','GetListActive','WaypointDeleteById','WaypointRecordCount','WaypointRecordCountByPlaceCast','getPagingLimit','paging','getListWaypointFolder','GetPlaceCastById','GetPlaceCastInactive'));
	}
