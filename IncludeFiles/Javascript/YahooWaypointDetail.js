...
/*******************************************************************************************************************
	...
	*********************************************************************************************************************/
function loadmap(pLong1,pLat1,pLong2,pLat2,pLong3,pLat3,pLong4,pLat4,pWapointLat,pWapointLong,pWaypointRadius,pIntCounter)
{
	...
	//Display the map centered on a latitude and longitude
		...
		var G_CENT_POINT_WAYPOINT=new YGeoPoint(pWapointLat,pWapointLong); 
		objMap.drawZoomAndCenter(G_CENT_POINT_WAYPOINT,8);

		objMarker = new YMarker(G_CENT_POINT_WAYPOINT);
		objMarker=createMarker(G_CENT_POINT_WAYPOINT,'');
		var strLabelString="<blink>"+pIntCounter+"</blink>";
		objMarker.addLabel(strLabelString);
		
		if(pWaypointRadius!=null)
		{
			var waypointRadius= pWaypointRadius/1000;
