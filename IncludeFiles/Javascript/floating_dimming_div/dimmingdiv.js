...
{
 if (isMozilla) {
	document.write('<div id="dimmer" class="dimmer" style="width:940px; height:833px;"></div>');
	}
	 else
	{ 
    document.write('<div id="dimmer" class="dimmer" style="width:1020px; height:850px;"></div>');
	}
}
...
/*	addHeader = '<table style="width:' + width + 'px" class="floatingHeader">' +
	            ...
	            '<img alt="Close..." title="Close..." src="/IncludeFiles/Javascript/floating_dimming_div/close.jpg" border="0"></a></td></tr></table>';
	*/
