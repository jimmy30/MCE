...
if(!isset($_SESSION[sessionKeys::USER_EMAIL]) || $_SESSION[sessionKeys::USER_EMAIL]=="" || $_SESSION[sessionKeys::USER_TYPE]==1 || $_SESSION[sessionKeys::USER_TYPE]==3)
{
...
$url.="?counter=".$_REQUEST["counter"]."&maxCount=".$_REQUEST["maxCount"];
	...
	<input type="hidden" name="urlAfterLoginProducer" id="urlAfterLoginProducer" value="<?php echo $url;?>">
	</form>
	</body>
	</html>
