...
require_once($_SERVER['DOCUMENT_ROOT']."/GUIService/Placecast/Consumer/PlaceCastDetailService.php");
  ...
  <form name="frmPlaceCast" action="" method="post" onSubmit="">
    ...
    <tr>
      <td height="18" colspan="2"><table border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td rowspan="2" width="380"><?php $objReg->GetPlaceCastById($_REQUEST["id"],1)?></td>
      ...
      <td height="44" colspan="2"><table width="660" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td height="24" colspan="3" align="left" valign="top"><div align="center"><a href="ViewPlaceCast.php" class="LinkSmall">
              <input name="button" type="button" class="RegistrationButton" onClick="location.href='/Placecast/Consumer/ViewPlaceCast.php'" value="Back to PlaceCast">
            </a></div></td>
          </tr>
          <tr>
